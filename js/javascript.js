...
$.getJSON( "js/blogEntries.json", function(data) {
  ...
  {
    numOfEntries++;
    $(".blogPosts" + numOfEntries).append("<h5 class='centerText group" + numOfEntries + "'>" + value.date + "</h5>");//.hide();
    $(".blogPosts" + numOfEntries).append("<h5 class='centerText group" + numOfEntries + "'>" + value.title + "</h5>");//.hide();
    $(".blogPosts" + numOfEntries).append("<p class='centerText group" + numOfEntries + "'>" + value.text + "</p>");//.hide();
